# sanity-gatsby-portfolio-delete-me
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/gzjwh5un/settings/api) and create a token with read rights.
